@extends('layout', ['title' => Lang::get("Sequence"), 'subTitle' => Lang::get("Edit data sequence")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('sequence.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" class="form-control required" name="format" value="{{$data->format}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="number_increment" class="form-control required" value="{{$data->number_increment}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 pt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="use_date_range" value="1" @if($data->use_date_range == 1) checked @endif>
                                </div>
                            </div>
                        </div>
                    </div>
