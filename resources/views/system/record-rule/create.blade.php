@extends('layout', ['title' => Lang::get("Record Rule"), 'subTitle' => Lang::get("Create data record rule")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('record-rule.store')}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="link" class="form-control required" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label required">{{__("Rule")}}</label>
                            <div class="col-md-9">
                                <textarea name="rule" class="form-control required" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
