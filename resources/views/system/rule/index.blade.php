@extends('layout', ['title' => Lang::get("Rule"), 'subTitle' => Lang::get("Manage data rule")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('rule-create')
                                <a href="{{route('rule.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>                                                
                                @endcan
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('rule-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('rule-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
