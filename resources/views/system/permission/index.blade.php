@extends('layout', ['title' => Lang::get("Permission"), 'subTitle' => Lang::get("Manage data permission")])
                    ...
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                ...
                                <a href="{{route('permission.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>                                                
                                @endcan
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('permission-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('permission-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
