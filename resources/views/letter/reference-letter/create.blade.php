            ...
            <form action="{{route('reference-letter.store')}}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label required reference">{{__("Reference")}}</label>
                            ...
                            <label class="col-md-2 col-form-label required reference-clinic d-none">{{__("Reference Clinic")}}</label>
                            <div class="col-md-4 reference-clinic d-none">
                                <div class="input-group">
                                    <input type="text" name="reference_clinic_name" id="reference_clinic_name" class="form-control required">
