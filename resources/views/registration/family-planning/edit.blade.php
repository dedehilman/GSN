@extends('layout', ['title' => Lang::get("Family Planning Registration"), 'subTitle' => Lang::get("Edit data family planning registration")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('registration.family-planning.update', $data->id)}}" method="POST">
                @csrf
