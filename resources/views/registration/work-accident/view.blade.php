@extends('layout', ['title' => Lang::get("Work Accident"), 'subTitle' => Lang::get("View data work accident registration")])
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    <div class="btn-group">
                        <a href="{{route('registration.work-accident.download', $data->id)}}?type=queue" class="btn btn-default"><i class="fas fa fa-print"></i> {{__("Download")}}</a>
                        <button type="button" class="btn btn-default dropdown-toggle dropdown-icon" data-toggle="dropdown" aria-expanded="false">
                        </button>
                        <div class="dropdown-menu" role="menu" style="">
                            <a class="dropdown-item" href="{{route('registration.work-accident.download', $data->id)}}?type=queue">{{__('Queue')}}</a>
                            <a class="dropdown-item" href="{{route('registration.work-accident.download', $data->id)}}?type=patient-identity">{{__('Patient')}}</a>
                        </div>
                    </div>
