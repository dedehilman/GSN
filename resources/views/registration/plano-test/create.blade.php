@extends('layout', ['title' => Lang::get("Plano Test Registration"), 'subTitle' => Lang::get("Create data plano test registration")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('registration.plano-test.store')}}" method="POST">
                @csrf
