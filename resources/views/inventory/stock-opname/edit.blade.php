                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="period_name" id="period_name" class="form-control" value="{{$data->period->name}}" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="medicine_name" id="medicine_name" class="form-control" value="{{$data->medicine->name}}" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="clinic_name" id="clinic_name" class="form-control" value="{{$data->clinic->name}}" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="qty" class="form-control required" value="{{$data->qty}}">
                            </div>
                        </div>
                    </div>
