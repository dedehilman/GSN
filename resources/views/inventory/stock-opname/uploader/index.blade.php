@extends('layout', ['title' => Lang::get("Stock Opname Uploader"), 'subTitle' => Lang::get("Data stock opname uploader")])
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('stock-opname.uploader.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: '{{__("Stock Opname Uploader")}}',
