@extends('layout', ['title' => Lang::get("Family Planning"), 'subTitle' => Lang::get("Create data sick letter report")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('report.family-planning.store')}}" method="POST">
                @csrf
