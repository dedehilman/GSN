@extends('layout', ['title' => Lang::get("Outpatient"), 'subTitle' => Lang::get("View data sick letter report")])
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    @if($data->status == 2)
                        <a href="{{route('report.outpatient.download', $data->id)}}" class="btn btn-default"><i class="fas fa fa-print"></i> {{__("Download")}}</a>
                    @endif
                    <a href="{{route('report.outpatient.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
                </div>
            </div>
        </div>
    </div>
