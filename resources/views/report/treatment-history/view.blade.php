@extends('layout', ['title' => Lang::get("Treatment History"), 'subTitle' => Lang::get("View data treatment history report")])
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">       
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{__("Patient")}}</label>
                        <div class="col-md-5 col-form-label">{{$data->patient->code}} - {{$data->patient->name}}</div>
                    </div>
                </div>
                <div class="card-footer text-right">
                    @if($data->status == 2)
                        <a href="{{route('report.treatment-history.download', $data->id)}}" class="btn btn-default"><i class="fas fa fa-print"></i> {{__("Download")}}</a>
                    @endif
