@extends('layout', ['title' => Lang::get("Inventory"), 'subTitle' => Lang::get("Manage data stock transaction report")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('stock-transaction-report-create')
                                <a href="{{route('report.stock-transaction.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('report.stock-transaction.datatable')}}",
                    type: 'POST',
                    data: function(data){
