@extends('layout', ['title' => Lang::get("Inventory"), 'subTitle' => Lang::get("View data stock transaction report")])
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    @if($data->status == 2)
                        <a href="{{route('report.stock-transaction.download', $data->id)}}" class="btn btn-default"><i class="fas fa fa-print"></i> {{__("Download")}}</a>
                    @endif
                    <a href="{{route('report.stock-transaction.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
                </div>
            </div>
        </div>
    </div>
