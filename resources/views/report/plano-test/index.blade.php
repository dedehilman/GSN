@extends('layout', ['title' => Lang::get("Plano Test"), 'subTitle' => Lang::get("Manage data sick letter report")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                {{-- @can('plano-test-report-create') --}}
                                <a href="{{route('report.plano-test.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                {{-- @endcan --}}
                            </div>
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('report.plano-test.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('grievance-report-plano-test-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
