@extends('layout', ['title' => Lang::get("Sick Letter"), 'subTitle' => Lang::get("Manage data sick letter report")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                {{-- @can('sick-letter-report-create') --}}
                                <a href="{{route('report.sick-letter.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                {{-- @endcan --}}
                            </div>
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('report.sick-letter.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('grievance-report-sick-letter-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
