<table>
    <tr>
        <td colspan="14" align="center">DATA KECELAKAAN KERJA</td>
    </tr>
    <tr>
        <td colspan="14" align="center">{{$reportModel->clinic->name}}</td>
    </tr>
    <tr>
        <td colspan="14" align="center">PERIODE : {{$reportModel->start_date}} - {{$reportModel->end_date}}</td>
    </tr>
</table>
<table>
    <thead>
