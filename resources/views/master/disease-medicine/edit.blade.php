@extends('layout', ['title' => Lang::get("Disease Medicine"), 'subTitle' => Lang::get("Edit data disease medicine")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('disease-medicine.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="disease_name" id="disease_name" class="form-control" value="{{$data->disease->code}} {{$data->disease->name}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="medicine_rule_name" id="medicine_rule_name" class="form-control" value="{{$data->medicineRule->code}} {{$data->medicineRule->name}}">
                                    <input type="hidden" name="medicine_rule_id" id="medicine_rule_id" value="{{$data->medicineRule->id}}">
                                    <div class="input-group-append">
