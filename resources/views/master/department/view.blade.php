@extends('layout', ['title' => Lang::get("Department"), 'subTitle' => Lang::get("View data department")])
            ...
            <div class="card">
                ...
                <div class="card-body">       
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-form-label">{{$data->parent->code ?? ''}} {{$data->parent->name ?? ''}}</div>
                    </div>
                </div>
