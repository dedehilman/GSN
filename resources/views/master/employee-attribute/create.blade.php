@extends('layout', ['title' => Lang::get("Employee Attribute"), 'subTitle' => Lang::get("Create data employee attribute")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('employee.attribute.store', ['parentId'=>$data->id])}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="attribute_name" id="attribute_name" class="form-control required">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('employee.attribute.index', ['parentId'=>$data->id])}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
