                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="reference_type_name" id="reference_type_name" class="form-control" value="{{$data->referenceType->code}} {{$data->referenceType->name}}">
                                    <input type="hidden" name="reference_type_id" id="reference_type_id" value="{{$data->referenceType->id}}">
