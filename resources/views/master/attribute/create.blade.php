@extends('layout', ['title' => Lang::get("Attribute"), 'subTitle' => Lang::get("Create data attribute")])
            ...
            <form action="{{route('attribute.store')}}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('attribute.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
