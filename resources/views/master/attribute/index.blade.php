@extends('layout', ['title' => Lang::get("Attribute"), 'subTitle' => Lang::get("Manage data attribute")])
                    ...
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                ...
                                <a href="{{route('attribute.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('attribute-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('attribute-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
