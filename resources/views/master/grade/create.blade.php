@extends('layout', ['title' => Lang::get("Grade"), 'subTitle' => Lang::get("Create data grade")])
            ...
            <form action="{{route('grade.store')}}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('grade.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
