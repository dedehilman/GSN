@extends('layout', ['title' => Lang::get("Position"), 'subTitle' => Lang::get("Create data position")])
            ...
            <form action="{{route('position.store')}}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('position.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
