@extends('layout', ['title' => Lang::get("Exposure"), 'subTitle' => Lang::get("Manage data exposure")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('exposure-create')
                                <a href="{{route('exposure.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('exposure-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('exposure-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
