@extends('layout', ['title' => Lang::get("Exposure"), 'subTitle' => Lang::get("Edit data exposure")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('exposure.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('exposure.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
