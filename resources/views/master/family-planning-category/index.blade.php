@extends('layout', ['title' => Lang::get("Family Planning Category"), 'subTitle' => Lang::get("Manage data family planning category")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('family-planning-category-create')
                                <a href="{{route('family-planning-category.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('family-planning-category.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('family-planning-category-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('family-planning-category-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: '{{__("Family Planning Category")}}',
