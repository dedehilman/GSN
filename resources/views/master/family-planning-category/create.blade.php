@extends('layout', ['title' => Lang::get("Family Planning Category"), 'subTitle' => Lang::get("Create data family planning category")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('family-planning-category.store')}}" method="POST">
                @csrf
