@extends('layout', ['title' => Lang::get("Project"), 'subTitle' => Lang::get("Manage data product project")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                <!-- @can('unit-create') -->
                                <a href="{{route('project.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                <!-- @endcan -->
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        // visible: @can('unit-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        // visible: @can('unit-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
