@extends('layout', ['title' => Lang::get("Employee Department"), 'subTitle' => Lang::get("View data employee department")])
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">       
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{__("Department")}}</label>
                        <div class="col-md-9 col-form-label">{{$data->department->name}}</div>
                    </div>
                    <div class="form-group row">
