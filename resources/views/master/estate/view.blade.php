@extends('layout', ['title' => Lang::get("Business Area"), 'subTitle' => Lang::get("View data business area")])
            ...
            <div class="card">
                ...
                <div class="card-body">       
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-form-label">{{$data->company->code}} {{$data->company->name}}</div>
                    </div>
                </div>
