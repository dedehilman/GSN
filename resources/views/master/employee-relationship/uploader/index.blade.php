@extends('layout', ['title' => Lang::get("Employee Relationship Uploader"), 'subTitle' => Lang::get("Data employee relationship uploader")])
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('employee-relationship.uploader.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: '{{__("Employee Relationship Uploader")}}',
