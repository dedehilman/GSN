@extends('layout', ['title' => Lang::get("Symptom"), 'subTitle' => Lang::get("Edit data symptom")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('symptom.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('symptom.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
