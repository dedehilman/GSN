@extends('layout', ['title' => Lang::get("Symptom"), 'subTitle' => Lang::get("Manage data symptom")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('symptom-create')
                                <a href="{{route('symptom.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('symptom-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('symptom-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
