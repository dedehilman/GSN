                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="birth_date" class="form-control date" value="{{$data->birth_date}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="identity_number" class="form-control" value="{{$data->identity_number}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="join_date" class="form-control date" value="{{$data->join_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="no_bpjs_kesehatan" class="form-control" value="{{$data->no_bpjs_kesehatan}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{__("BPJS Ketenagakerjaan")}}</label>
                            <div class="col-md-9">
                                <input type="text" name="no_bpjs_ketenagakerjaan" class="form-control" value="{{$data->no_bpjs_ketenagakerjaan}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="work_unit_name" id="work_unit_name" class="form-control" readonly value="{{$data->workUnit->name ?? ''}}">
                                    <input type="hidden" name="work_unit_id" id="work_unit_id" value="{{$data->workUnit->id ?? ''}}">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="grade_name" id="grade_name" class="form-control" readonly value="{{$data->grade->name ?? ''}}">
                                    <input type="hidden" name="grade_id" id="grade_id" value="{{$data->grade->id ?? ''}}">
                                    <div class="input-group-append">
