@extends('layout', ['title' => Lang::get("Employee Uploader"), 'subTitle' => Lang::get("View data employee uploader")])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-form-label">{{$data->afdelink}}</div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{__("Work Unit")}}</label>
                        <div class="col-md-9 col-form-label">{{$data->work_unit}}</div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{__("Grade")}}</label>
                        <div class="col-md-9 col-form-label">{{$data->grade}}</div>
                    </div>
                </div>
                <div class="card-footer text-right">
                    <a href="{{route('employee.uploader.index', ["uplNo"=>$data->upl_no])}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
                </div>
            </div>
        </div>
    </div>
