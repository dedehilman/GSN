@extends('layout', ['title' => Lang::get("Work Accident Category"), 'subTitle' => Lang::get("Edit data work accident category")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('work-accident-category.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('work-accident-category.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
