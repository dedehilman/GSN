@extends('layout', ['title' => Lang::get("Work Accident Category"), 'subTitle' => Lang::get("Manage data work accident category")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                @can('work-accident-category-create')
                                <a href="{{route('work-accident-category.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                @endcan
                            </div>
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('work-accident-category.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('work-accident-category-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('work-accident-category-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
                ...
                buttons: [
                    {
                        extend: 'excel',
                        title: '{{__("Work Accident Category")}}',
