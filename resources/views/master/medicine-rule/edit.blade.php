@extends('layout', ['title' => Lang::get("Medicine Rule"), 'subTitle' => Lang::get("Edit data medicine rule")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('medicine-rule.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('medicine-rule.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
