@extends('layout', ['title' => Lang::get("Diagnosis Symptom"), 'subTitle' => Lang::get("Create data diagnosis symptom")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('diagnosis-symptom.store')}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">     
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label required">{{__("Symptom")}}</label>
                            <div class="col-md-9">
                                <div class="input-group">
