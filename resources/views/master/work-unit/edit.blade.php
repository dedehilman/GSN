@extends('layout', ['title' => Lang::get("Work Unit"), 'subTitle' => Lang::get("Edit data work-unit")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('work-unit.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('work-unit.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
