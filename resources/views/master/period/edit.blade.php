@extends('layout', ['title' => Lang::get("Period"), 'subTitle' => Lang::get("Edit data period")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('period.update', $data->id)}}" method="POST">
                @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="start_date" class="form-control required date" value="{{$data->start_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="end_date" class="form-control required date" value="{{$data->end_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
