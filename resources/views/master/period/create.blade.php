@extends('layout', ['title' => Lang::get("Period"), 'subTitle' => Lang::get("Create data period")])
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="start_date" class="form-control required date">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="end_date" class="form-control required date">
                                </div>
                            </div>
                        </div>
                    </div>
