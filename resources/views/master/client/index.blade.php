@extends('layout', ['title' => Lang::get("Client"), 'subTitle' => Lang::get("Manage data product client")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                <!-- @can('unit-create') -->
                                <a href="{{route('client.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                <!-- @endcan -->
                            </div>
