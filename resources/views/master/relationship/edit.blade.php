@extends('layout', ['title' => Lang::get("Relationship"), 'subTitle' => Lang::get("Edit data relationship")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('relationship.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('relationship.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
