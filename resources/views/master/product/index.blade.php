@extends('layout', ['title' => Lang::get("Product"), 'subTitle' => Lang::get("Manage data product")])
                ...
                <div class="card-body">                    
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-between">
                            <div>
                                <!-- @can('unit-create') -->
                                <a href="{{route('product.create')}}" class="btn btn-primary" id="btn-add"><i class="fas fa-plus"></i> {{__('Create')}}</a>
                                <!-- @endcan -->
                            </div>
