@extends('layout', ['title' => Lang::get("Company Group"), 'subTitle' => Lang::get("Edit data company group")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('company-group.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('company-group.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
