@extends('layout', ['title' => Lang::get("Reference Type"), 'subTitle' => Lang::get("Edit data reference type")])

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('reference-type.update', $data->id)}}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('reference-type.index')}}" class="btn btn-default"><i class="fas fa fa-undo"></i> {{__("Back")}}</a>
