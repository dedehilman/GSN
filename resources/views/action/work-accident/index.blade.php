@extends('layout', ['title' => Lang::get("Work Accident"), 'subTitle' => Lang::get("Manage data work accident")])
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" style="padding:10px 0px 0px 0px;">
                                <form id="formSearch">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="work_accidents.reference_type" class="form-control custom-select">
                                                <option value=""></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 referenceRow d-none">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="work_accidents.reference_id" id="reference_id">
                                                <div class="input-group-append">
    ...
    <script>
        $('document').ready(function(){
            $('#datatable').DataTable({
                ajax:
                {
                    url: "{{route('action.work-accident.datatable')}}",
                    type: 'POST',
                    data: function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        visible: @can('action-work-accident-delete') true @else false @endcan,
                        render: function(data, type, row)
                        {
                    ...
                    },
                    {
                        ...
                        defaultContent: '',
                        className: 'text-center',
                        visible: @can('action-work-accident-edit') true @else false @endcan,
                        render: function(data, type, row)
                        {
