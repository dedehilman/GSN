@extends('layout', ['title' => Lang::get("Outpatient"), 'subTitle' => Lang::get("Edit data outpatient")])
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('action.outpatient.update', $data->id)}}" method="POST">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="#tab1" role="tab" aria-selected="true">{{ __("Diagnosis") }}</a>
                                    </li>
                                    <li class="nav-item">
...
@section('script')
    ...
    <script>
        MEDIA_URL = "{{route('action.outpatient.store-media')}}"; 
