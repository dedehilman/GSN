                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" style="padding:10px 0px 0px 0px;">
                                <form id="formSearch">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="plano_tests.reference_type" class="form-control custom-select">
                                                <option value=""></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 referenceRow d-none">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="plano_tests.reference_id" id="reference_id">
                                                <div class="input-group-append">
