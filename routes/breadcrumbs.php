...
// Employee Position
Breadcrumbs::for('employee.position.index', function ($trail, $data) {
    $trail->parent('employee.index');
    $trail->push($data->name, route('employee.show', $data->id));
    $trail->push(Lang::get('Position'), route('employee.position.index', $data->id));
});
Breadcrumbs::for('employee.position.create', function ($trail, $data) {
    $trail->parent('employee.position.index', $data);
    $trail->push(Lang::get('Create'), route('employee.position.create', $data->id));
});
Breadcrumbs::for('employee.position.show', function ($trail, $data) {
    $trail->parent('employee.position.index', $data->employee);
    $trail->push(Lang::get('Show'), route('employee.position.show', ["parentId"=>$data->employee_id,"position"=>$data->id]));
});
Breadcrumbs::for('employee.position.edit', function ($trail, $data) {
    $trail->parent('employee.position.index', $data->employee);
    $trail->push(Lang::get('Edit'), route('employee.position.edit', ["parentId"=>$data->employee_id,"position"=>$data->id]));
});

// Employee Department
Breadcrumbs::for('employee.department.index', function ($trail, $data) {
    $trail->parent('employee.index');
    $trail->push($data->name, route('employee.show', $data->id));
    $trail->push(Lang::get('Department'), route('employee.department.index', $data->id));
});
Breadcrumbs::for('employee.department.create', function ($trail, $data) {
    $trail->parent('employee.department.index', $data);
    $trail->push(Lang::get('Create'), route('employee.department.create', $data->id));
});
Breadcrumbs::for('employee.department.show', function ($trail, $data) {
    $trail->parent('employee.department.index', $data->employee);
    $trail->push(Lang::get('Show'), route('employee.department.show', ["parentId"=>$data->employee_id,"department"=>$data->id]));
});
Breadcrumbs::for('employee.department.edit', function ($trail, $data) {
    $trail->parent('employee.department.index', $data->employee);
    $trail->push(Lang::get('Edit'), route('employee.department.edit', ["parentId"=>$data->employee_id,"department"=>$data->id]));
});

// Employee Company
Breadcrumbs::for('employee.company.index', function ($trail, $data) {
    $trail->parent('employee.index');
    $trail->push($data->name, route('employee.show', $data->id));
    $trail->push(Lang::get('Company'), route('employee.company.index', $data->id));
});
Breadcrumbs::for('employee.company.create', function ($trail, $data) {
    $trail->parent('employee.company.index', $data);
    $trail->push(Lang::get('Create'), route('employee.company.create', $data->id));
});
Breadcrumbs::for('employee.company.show', function ($trail, $data) {
    $trail->parent('employee.company.index', $data->employee);
    $trail->push(Lang::get('Show'), route('employee.company.show', ["parentId"=>$data->employee_id,"company"=>$data->id]));
});
Breadcrumbs::for('employee.company.edit', function ($trail, $data) {
    $trail->parent('employee.company.index', $data->employee);
    $trail->push(Lang::get('Edit'), route('employee.company.edit', ["parentId"=>$data->employee_id,"company"=>$data->id]));
});

// Employee Attribute
Breadcrumbs::for('employee.attribute.index', function ($trail, $data) {
    $trail->parent('employee.index');
    $trail->push($data->name, route('employee.show', $data->id));
    $trail->push(Lang::get('Attribute'), route('employee.attribute.index', $data->id));
});
Breadcrumbs::for('employee.attribute.create', function ($trail, $data) {
    $trail->parent('employee.attribute.index', $data);
    $trail->push(Lang::get('Create'), route('employee.attribute.create', $data->id));
});
Breadcrumbs::for('employee.attribute.show', function ($trail, $data) {
    $trail->parent('employee.attribute.index', $data->employee);
    $trail->push(Lang::get('Show'), route('employee.attribute.show', ["parentId"=>$data->employee_id,"attribute"=>$data->id]));
});
Breadcrumbs::for('employee.attribute.edit', function ($trail, $data) {
    $trail->parent('employee.attribute.index', $data->employee);
    $trail->push(Lang::get('Edit'), route('employee.attribute.edit', ["parentId"=>$data->employee_id,"attribute"=>$data->id]));
});