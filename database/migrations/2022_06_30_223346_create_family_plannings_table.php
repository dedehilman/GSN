...
class CreateFamilyPlanningsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('family_plannings', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('family_planning_category_id')->nullable();
            ...
            $table->foreign('family_planning_category_id')->references('id')->on('family_planning_categories')->onDelete('cascade');
