...
class CreatePlanoTestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plano_tests', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('pregnancy_num')->nullable();
    ...
    {
        Schema::dropIfExists('plano_tests');
    }
}
