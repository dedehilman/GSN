...
class StockTransactionExport implements ShouldAutoSize, FromView
{
    use Exportable;
    ...
    {
        $datas = StockTransaction::where('clinic_id', $this->reportModel->clinic_id);
        ...
        $datas = $datas->get();
        return view('report.stock-transaction.template', [
